...
const userSchema = new mongoose.Schema({
  ...
  returnTemplate: { type: String, default: 'Olá {cliente}! {medico} recomenda que você agende um retorno em {dias}. Entre em contato para marcar sua consulta de retorno.' },
